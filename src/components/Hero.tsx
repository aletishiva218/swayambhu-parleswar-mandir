    ...
    <div className="hero-section h-screen flex items-center justify-center">
      <div className="text-center text-white max-w-4xl px-4">
        ...
        <h1 className="font-devnagari text-4xl sm:text-5xl md:text-6xl font-bold mb-4 animate-fade-in">
          ॐ नमः शिवाय | Welcome to <span className='flex flex-nowrap'><span className='flex flex-col'><span className='text-[2rem] text-start'>ग्रामदेव</span><span>स्वयंभू</span></span> पालेश्वर महादेव मंदिर देवस्थान</span>
        </h1>
